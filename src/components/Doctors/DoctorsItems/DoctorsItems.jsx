  ...
  return (
    <div className={styles["doctors-items"]}>
      <div className={styles["doctors-item"]}>
        <img
          src="/friendly-dental-studio/img/Doctors/1.png"
          alt="doctor image"
        />
      ...
      <div className={styles["doctors-item"]}>
        <img
          src="/friendly-dental-studio/img/Doctors/2.png"
          alt="doctor image"
        />
      ...
      <div className={styles["doctors-item"]}>
        <img
          src="/friendly-dental-studio/img/Doctors/3.png"
          alt="doctor image"
        />
      ...
      <div className={styles["doctors-item"]}>
        <img
          src="/friendly-dental-studio/img/Doctors/4.png"
          alt="doctor image"
        />
      ...
      <div className={styles["doctors-item"]}>
        <img
          src="/friendly-dental-studio/img/Doctors/5.png"
          alt="doctor image"
        />
      ...
      <div className={styles["doctors-item"]}>
        <img
          src="/friendly-dental-studio/img/Doctors/6.png"
          alt="doctor image"
        />
      ...
      <div className={styles["doctors-item"]}>
        <img
          src="/friendly-dental-studio/img/Doctors/8.png"
          alt="doctor image"
        />
      ...
      <div className={styles["doctors-item"]}>
        <img
          src="/friendly-dental-studio/img/Doctors/7.png"
          alt="doctor image"
        />
      ...
      <div className={styles["doctors-item"]}>
        <img
          src="/friendly-dental-studio/img/Doctors/9.png"
          alt="doctor image"
        />
